...
const UserDetailPage = ({ user }: { user: AuthUser }) => {
  ...
  const handleToggleSync = async (syncId: string, currentStatus: boolean) => {
    try {
      ...
      <div className="space-y-6">
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                ...
                {userDetail.username && (
                  <CardDescription className="text-base">@{userDetail.username}</CardDescription>
                )}
              ...
              <div className="flex flex-col gap-2">
                ...
                {userDetail.subscriptionStatus && (
                  <Badge variant="outline">{userDetail.subscriptionStatus}</Badge>
                )}
              </div>
            </div>
          </CardHeader>
        ...
        <Tabs defaultValue="syncs">
          ...
          <TabsContent value="syncs" className="space-y-4">
            {userDetail.syncConfigs && userDetail.syncConfigs.length > 0 ? (
              userDetail.syncConfigs.map((sync: any) => (
                <Card key={sync.id}>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => handleToggleSync(sync.id, sync.isActive)}
                        >
                          {sync.isActive ? (
                            <>
                  ...
                  {sync.syncLogs && sync.syncLogs.length > 0 && (
                    <CardContent>
                      <p className="text-sm font-medium mb-2">Recent Logs:</p>
                      <div className="space-y-1">
                        {sync.syncLogs.slice(0, 5).map((log: any) => (
                          <div
                            key={log.id}
                            className="border-border flex items-center justify-between border-b pb-1 text-sm last:border-0"
                          >
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleRefreshToken('airtable')}
                    >
          ...
          <TabsContent value="usage" className="space-y-4">
            <Card>
              ...
              <CardContent>
                {userDetail.usageStats && userDetail.usageStats.length > 0 ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setEditFormData({ ...editFormData, subscriptionStatus: value })
                  }
                >
                  <SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setEditFormData({ ...editFormData, isAdmin: checked })
                  }
                />
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={isDeleting || deleteConfirmEmail !== userDetail.email}
              >
