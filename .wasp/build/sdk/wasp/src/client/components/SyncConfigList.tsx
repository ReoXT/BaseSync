 ...
 */
export function SyncConfigList({
  syncConfigs,
  isLoading = false,
  onEdit,
  onSyncNow,
  ...
  const formatLastSync = (timestamp: Date | string | undefined): string => {
  ...
  const getSyncDirectionDisplay = (config: SyncConfig) => {
