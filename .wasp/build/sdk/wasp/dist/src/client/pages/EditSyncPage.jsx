...
export default function EditSyncPage() {
    ...
    const { data: syncConfig, isLoading, error, } = useQuery(getSyncConfigById, { syncConfigId: id || "" });
    // Loading state
    if (isLoading) {
        ...
        <div className="relative z-10 py-10 lg:mt-10">
          <div className="mx-auto max-w-5xl px-6 lg:px-8">
            <Button variant="ghost" size="sm" onClick={() => navigate("/dashboard")} className="mb-4 hover:bg-cyan-500/5 transition-colors">
    ...
    if (error || !syncConfig) {
        ...
        <div className="relative z-10 py-10 lg:mt-10">
          <div className="mx-auto max-w-5xl px-6 lg:px-8">
            ...
            <div className="mt-4">
              <Button onClick={() => navigate("/dashboard")} className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white">
                Return to Dashboard
              </Button>
            </div>
          </div>
    ...
    const initialData = {
        ...
        airtableBaseName: syncConfig.airtableBaseName || undefined,
        airtableTableId: syncConfig.airtableTableId,
        airtableTableName: syncConfig.airtableTableName || undefined,
        airtableViewId: syncConfig.airtableViewId || undefined,
        googleSpreadsheetId: syncConfig.googleSpreadsheetId,
        googleSpreadsheetName: syncConfig.googleSpreadsheetName || undefined,
...
//# sourceMappingURL=EditSyncPage.jsx.map