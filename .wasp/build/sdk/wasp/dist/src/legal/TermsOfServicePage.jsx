...
export default function TermsOfServicePage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        ].map((item, idx) => (<div key={idx} className="flex items-start gap-2 text-slate-700 bg-slate-50 p-3 rounded-lg border border-slate-200">
...
//# sourceMappingURL=TermsOfServicePage.jsx.map