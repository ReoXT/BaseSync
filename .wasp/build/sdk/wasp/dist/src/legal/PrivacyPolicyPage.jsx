...
export default function PrivacyPolicyPage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2 group">
              <img src="/logo.png" alt="BaseSync Logo" className="w-8 h-8 object-contain group-hover:scale-105 transition-transform"/>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="lg:sticky lg:top-28">
              <div className="bg-white rounded-2xl shadow-md border border-slate-200/60 p-6">
                ...
                <nav className="space-y-1">
                  {tableOfContents.map((item) => (<button key={item.id} onClick={() => scrollToSection(item.id)} className={`block w-full text-left px-3 py-2 text-sm rounded-lg transition-all ${activeSection === item.id
        ...
        ].map((item, idx) => (<li key={idx} className="flex gap-3">
                ...
                icon: '⏸️',
        ...
        ].map((right, idx) => (<div key={idx} className="bg-slate-50 border border-slate-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
                    ...
                    <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded">
                      <p className="text-slate-700 leading-relaxed">
                        ...
                        <a href="mailto:support@basesync.app" className="text-blue-600 hover:underline font-medium">
...
//# sourceMappingURL=PrivacyPolicyPage.jsx.map