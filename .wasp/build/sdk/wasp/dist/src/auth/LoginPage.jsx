    ...
    return (<AuthPageLayout>
      ...
      <div className="space-y-4 pt-6 border-t border-border/50">
        ...
        <div className="flex items-center justify-center gap-2 text-sm">
          ...
          <WaspRouterLink to={routes.SignupRoute.to} className="font-medium text-cyan-400 hover:text-cyan-300 transition-colors duration-200 inline-flex items-center gap-1 group">
            Sign up
        ...
        <div className="flex items-center justify-center gap-2 text-sm">
          ...
          <WaspRouterLink to={routes.RequestPasswordResetRoute.to} className="font-medium text-cyan-400 hover:text-cyan-300 transition-colors duration-200 inline-flex items-center gap-1 group">
            Reset it
            <svg className="w-4 h-4 transition-transform duration-200 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6"/>
            </svg>
