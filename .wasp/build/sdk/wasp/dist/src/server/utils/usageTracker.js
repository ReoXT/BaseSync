 ...
 */
export async function trackRecordsSynced(userId, count) {
    if (count <= 0)
        return;
    const monthStart = getMonthStart();
 ...
 * @param userId - User ID
 */
export async function trackSyncConfigCreated(userId) {
    const monthStart = getMonthStart();
    await prisma.usageStats.upsert({
        where: {
            userId_month: {
 ...
 */
export async function getUsageForMonth(userId, month = new Date()) {
 ...
 */
export async function getTotalRecordsSynced(userId) {
 ...
 */
export async function getTotalSyncConfigsCreated(userId) {
    const result = await prisma.usageStats.aggregate({
        where: {
            userId,
        },
 ...
 * @param count - Number of records synced
 */
export async function trackRecordsSyncedWithNotifications(user, count) {
    if (count <= 0)
        return;
    // Track the usage
 ...
 * @param user - The user entity (with email for notifications)
 */
export async function trackSyncConfigCreatedWithNotifications(user) {
    // Track the usage
