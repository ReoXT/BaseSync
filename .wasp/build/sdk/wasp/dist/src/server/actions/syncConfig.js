 ...
 */
export const createSyncConfig = async (args, context) => {
    if (!context.user) {
 ...
 */
export const updateSyncConfig = async (args, context) => {
    if (!context.user) {
        throw new Error('User must be authenticated');
    }
    ...
    if (finalSyncDirection === 'BIDIRECTIONAL') {
        const finalConflictResolution = updates.conflictResolution ||
 ...
 */
export const deleteSyncConfig = async (args, context) => {
    if (!context.user) {
        throw new Error('User must be authenticated');
    }
 ...
 */
export const toggleSyncActive = async (args, context) => {
    if (!context.user) {
        throw new Error('User must be authenticated');
    }
