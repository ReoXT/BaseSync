        ...
        <Tabs defaultValue={failed.length > 0 ? "failed" : "active"}>
            ...
            <Card>
              ...
              <CardContent>
                {active.length > 0 ? (<Table>
                    ...
                    <TableBody>
                      {active.map((log) => {
                const duration = Math.floor((new Date().getTime() - new Date(log.startedAt).getTime()) / 1000);
                return (<TableRow key={log.id} className="cursor-pointer hover:bg-accent" onClick={() => navigate(`/admin/users/${log.syncConfig.userId}`)}>
          ...
          <TabsContent value="recent">
            <Card>
              ...
              <CardContent>
                {recentCompleted.length > 0 ? (<Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead>User</TableHead>
                        <TableHead>Sync Name</TableHead>
                ...
                const duration = log.completedAt && log.startedAt
                    ? Math.floor((new Date(log.completedAt).getTime() -
          ...
          <TabsContent value="failed">
            <Card>
              ...
              <CardContent>
                {failed.length > 0 ? (<div className="space-y-4">
                    {failed.map((log) => {
                ...
                return (<Card key={log.id} className="border-red-200 cursor-pointer hover:shadow-md" onClick={() => navigate(`/admin/users/${log.syncConfig.userId}`)}>
                          <CardHeader>
...
//# sourceMappingURL=SyncMonitorPage.jsx.map