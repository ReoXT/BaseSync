...
function ExportDataCard() {
  ...
  return (
    <div className="rounded-2xl border border-amber-500/30 bg-card/50 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-amber-500/50">
      <div className="p-6 md:p-8 space-y-6">
        ...
        <Button
          ...
          className="border-amber-500/30 hover:border-amber-500 hover:bg-amber-500/10 transition-all duration-300"
        >
...
function DeleteAccountCard() {
  ...
  return (
    <div className="rounded-2xl border border-red-500/30 bg-gradient-to-br from-red-500/5 to-red-600/5 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-red-500/50">
      <div className="p-6 md:p-8 space-y-6">
        <div className="flex items-center gap-3">
        ...
        <Dialog open={isOpen} onOpenChange={handleDialogOpenChange}>
          <DialogTrigger asChild>
            <Button
              variant="destructive"
              className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white shadow-lg shadow-red-500/20 hover:shadow-red-500/40 transition-all duration-300"
            >
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="font-mono border-border bg-background/50 backdrop-blur-sm focus:border-red-500/50 transition-colors"
                        />
                      </FormControl>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="border-border bg-background/50 backdrop-blur-sm focus:border-red-500/50 transition-colors"
                        />
                      </FormControl>
                      <FormDescription className="text-xs text-muted-foreground">
