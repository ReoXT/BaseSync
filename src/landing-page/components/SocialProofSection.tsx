  ...
  return (
    <section ref={sectionRef} className="relative pt-8 pb-24 md:pt-12 md:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <TestimonialCard
            quote="We were spending 6+ hours weekly copying data between Airtable and Sheets. BaseSync cut that to zero. Best $19/month we've ever spent."
            author="Marcus Chen"
          ...
          />
          <TestimonialCard
            quote="Finally, linked records show actual names instead of 'rec123abc' IDs. Our executives can now read dashboards without constantly asking 'what does this mean?'"
            author="Rachel Patel"
            role="Product Operations Lead"
            company="Close CRM"
            avatar="/rachel-patel.jpg"
            delay={0.1}
            isVisible={isVisible}
          />
          <TestimonialCard
            quote="Bidirectional sync was a game changer. Sales updates Sheets, ops works in Airtable, everything stays in sync. No more 'which version is correct?' messages."
            author="David Kim"
...
function CompanyLogo({ name }: { name: string }) {
  const logos: Record<string, React.ReactElement> = {
    ...
    Monday: (
      <svg viewBox="0 0 155 35" fill="currentColor" className="w-full h-full">
    ...
    HubSpot: (
      <svg viewBox="0 0 100 28" fill="currentColor" className="w-full h-full">
    ...
    Salesforce: (
      <svg viewBox="0 0 100 72" fill="currentColor" className="w-full h-full">
    ...
    McKinsey: (
      <svg viewBox="0 0 200 40" fill="currentColor" className="w-full h-full">
  ...
  return (
    <div className="relative group flex items-center justify-center h-20">
      ...
      <div className="relative w-full h-full flex items-center justify-center px-4 transition-all duration-500">
        ...
        <div className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none blur-xl"
          style={{
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-border">
            ...
            {avatar ? (
              <img
                src={avatar}
                alt={author}
                className="shrink-0 w-12 h-12 rounded-full object-cover border border-cyan-500/20"
                style={{
