...
### Prompt 1.1: Core Database Models
...
- 10,000 records per sync
- 5-minute sync interval
- Priority support

Tier 3 - Business ($79/month):
- Unlimited sync configurations
- Unlimited records
- 5-minute sync interval
- Priority support
- Custom field transformations (future)

Find where OpenSaaS defines pricing (likely in a config file or main.wasp) and update accordingly. Do NOT break the existing Stripe webhook handling.
```

### Prompt 9.2: Usage Limits Enforcement
...
### Prompt 11.4: Pricing Section

```
Add pricing section matching the Stripe tiers:

Three pricing cards:
1. Starter - $29/mo - 1 sync, 1K records
2. Pro - $49/mo - 5 syncs, 10K records (Most Popular badge)
3. Business - $79/mo - Unlimited everything
