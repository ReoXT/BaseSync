        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-md p-4">
            <h4 className="font-medium text-gray-900 mb-2 flex items-center gap-2">
              ...
              {diagnostics.airtable.connected ? (
                <span className="text-xs px-2 py-1 bg-green-100 text-green-800 rounded">Connected</span>
              ) : (
                <span className="text-xs px-2 py-1 bg-red-100 text-red-800 rounded">Not Connected</span>
              )}
            </h4>
            <div className="space-y-1 text-sm">
              ...
              {diagnostics.airtable.lastRefreshError && (
          ...
          <div className="border border-gray-200 rounded-md p-4">
            ...
            <div className="space-y-1 text-sm">
              ...
              {diagnostics.google.lastRefreshError && (
                <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded">
                  <span className="text-xs text-red-800 font-medium">Last Error:</span>
          ...
          {/* Clear Flags Button */}
          {(diagnostics.airtable.needsReauth || diagnostics.google.needsReauth) && (
            <div className="flex justify-end pt-2">
              <button
                onClick={handleClearFlags}
                disabled={isClearing}
                className="px-4 py-2 bg-yellow-600 text-white rounded-md hover:bg-yellow-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition"
              >
