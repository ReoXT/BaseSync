...
export default function SolutionSection() {
    return (<section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-b from-transparent via-emerald-500/[0.02] to-transparent">
      {/* Background Pattern */}
...
function ComparisonRow({ problem, solution, delay, }) {
    return (<div className="relative grid md:grid-cols-2 gap-4 group" style={{
...
//# sourceMappingURL=SolutionSection.jsx.map