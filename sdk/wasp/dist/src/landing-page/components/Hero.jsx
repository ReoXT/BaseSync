...
export default function Hero() {
    return (<div className="relative w-full pt-0 pb-20 overflow-hidden">
      <AnimatedBackground />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="lg:mb-18 mx-auto max-w-4xl text-center relative z-10">
            ...
            <h1 className="text-foreground text-5xl md:text-7xl font-bold leading-tight tracking-tight mb-6 animate-slide-up">
              ...
              <span className="relative inline-block mt-2">
                ...
                <svg className="absolute -bottom-2 left-0 w-full" height="8" viewBox="0 0 400 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 4C100 2 200 6 400 4" stroke="url(#gradient)" strokeWidth="2" strokeLinecap="round"/>
                  <defs>
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-delayed-more">
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 px-8 py-6 text-lg transition-all duration-300" asChild>
                <WaspRouterLink to={routes.SignupRoute.to}>
                  Start Free Trial
                  <span className="ml-2" aria-hidden="true">→</span>
                </WaspRouterLink>
              </Button>
              <Button size="lg" variant="outline" className="border-cyan-500/30 hover:border-cyan-500 hover:bg-cyan-500/5 px-8 py-6 text-lg transition-all duration-300" asChild>
            ...
            <p className="mt-4 text-xs text-muted-foreground animate-fade-in-delayed-more">
              ...
              <WaspRouterLink to={routes.TermsOfServiceRoute.to} className="text-cyan-400 hover:text-cyan-300 underline underline-offset-2">
                Terms of Service
              </WaspRouterLink>
              {" "}and{" "}
              <WaspRouterLink to={routes.PrivacyPolicyRoute.to} className="text-cyan-400 hover:text-cyan-300 underline underline-offset-2">
                Privacy Policy
              </WaspRouterLink>
            </p>
          </div>
...
function HeroVisual() {
    return (<div className="mt-6 md:mt-8 relative z-10 animate-fade-in-delayed-more">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-px">
            <svg className="w-full h-24" viewBox="0 0 600 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Connection Line */}
              <line x1="100" y1="50" x2="500" y2="50" stroke="url(#lineGradient)" strokeWidth="2" strokeDasharray="4 4"/>

              {/* Bidirectional Arrows */}
              <path d="M110 45 L100 50 L110 55" stroke="#06b6d4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.4"/>
              <path d="M490 45 L500 50 L490 55" stroke="#06b6d4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.4"/>

              {/* Animated Particles - Left to Right */}
              <circle r="3" cy="50" fill="url(#particleGlow)" className="animate-travel-1">
                <animate attributeName="cx" from="100" to="500" dur="2s" repeatCount="indefinite"/>
              </circle>
              <circle r="2.5" cy="50" fill="#06b6d4" className="animate-travel-2">
                <animate attributeName="cx" from="100" to="500" dur="2.3s" repeatCount="indefinite"/>
              </circle>
              <circle r="2" cy="50" fill="#22d3ee" className="animate-travel-3">
                <animate attributeName="cx" from="100" to="500" dur="2.6s" repeatCount="indefinite"/>
              </circle>

              {/* Animated Particles - Right to Left */}
              <circle r="3" cy="50" fill="url(#particleGlow)" className="animate-travel-reverse-1">
                <animate attributeName="cx" from="500" to="100" dur="2.2s" repeatCount="indefinite"/>
              </circle>
              <circle r="2.5" cy="50" fill="#3b82f6" className="animate-travel-reverse-2">
                <animate attributeName="cx" from="500" to="100" dur="2.5s" repeatCount="indefinite"/>
              </circle>
              <circle r="2" cy="50" fill="#60a5fa" className="animate-travel-reverse-3">
                <animate attributeName="cx" from="500" to="100" dur="2.8s" repeatCount="indefinite"/>
              </circle>
            </svg>
          </div>
...
function AnimatedBackground() {
    return (<div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      {/* Gradient Orbs */}
      <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-cyan-500/10 blur-3xl animate-pulse-slow" aria-hidden="true"/>
      <div className="absolute top-1/2 -left-40 w-96 h-96 rounded-full bg-blue-500/10 blur-3xl animate-pulse-slower" aria-hidden="true"/>
    </div>);
}
