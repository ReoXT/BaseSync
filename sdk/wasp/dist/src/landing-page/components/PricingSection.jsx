...
export default function PricingSection() {
    ...
    return (<section ref={sectionRef} className="relative pt-8 pb-24 md:pt-12 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Gradient Orb */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-cyan-500/5 blur-3xl animate-pulse-slow" aria-hidden="true"/>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {tiers.map((tier, index) => (<PricingCard key={tier.id} tier={tier} billingPeriod={billingPeriod} delay={index * 0.1} isVisible={isVisible}/>))}
        </div>
...
function PricingCard({ tier, billingPeriod, delay, isVisible, }) {
    ...
    return (<div className={`relative transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{
      ...
      <div className={`relative h-full rounded-2xl border backdrop-blur-sm overflow-hidden transition-all duration-300 hover:scale-105 group ${tier.popular
        ...
        <div className="relative p-8">
          ...
          {/* CTA Button */}
          <Button size="lg" className={`w-full mb-6 transition-all duration-300 ${tier.popular
            ...
            : "border-cyan-500/30 hover:border-cyan-500 hover:bg-cyan-500/5"}`} variant={tier.popular ? "default" : "outline"} asChild>
...
//# sourceMappingURL=PricingSection.jsx.map