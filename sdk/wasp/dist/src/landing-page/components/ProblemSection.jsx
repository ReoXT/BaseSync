...
export default function ProblemSection() {
    ...
    return (<section ref={sectionRef} className="relative pt-8 pb-24 md:pt-12 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Dual Gradient Orbs */}
        <div className="absolute -top-40 left-1/4 w-96 h-96 rounded-full bg-red-500/5 blur-3xl animate-pulse-slower" aria-hidden="true"/>
        <div className="absolute -bottom-40 right-1/4 w-96 h-96 rounded-full bg-cyan-500/5 blur-3xl animate-pulse-slow" aria-hidden="true"/>
      </div>
        ...
        <div className={`grid lg:grid-cols-2 gap-8 transition-all duration-700 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="relative rounded-3xl border border-red-500/20 bg-gradient-to-br from-red-500/5 to-red-600/5 backdrop-blur-sm p-8 md:p-10 overflow-hidden group hover:border-red-500/30 transition-all duration-300">
            ...
            <div className="relative">
              ...
              <div className="space-y-5">
                {problems.map((problem, index) => (<div key={index} className="flex items-start gap-4 group/item" style={{
          ...
          <div className="relative rounded-3xl border border-cyan-500/30 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 backdrop-blur-sm p-8 md:p-10 overflow-hidden group hover:border-cyan-500/40 transition-all duration-300 shadow-lg shadow-cyan-500/10">
            ...
            <div className="relative">
              ...
              {/* Solutions List */}
              <div className="space-y-5">
                {solutions.map((solution, index) => (<div key={index} className="flex items-start gap-4 group/item" style={{
                animationDelay: `${index * 0.1}s`,
            }}>
                    {/* Checkmark Icon */}
...
//# sourceMappingURL=ProblemSection.jsx.map