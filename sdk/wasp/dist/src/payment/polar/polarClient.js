...
export function getPolarClient() {
    ...
    if (!accessToken || !sandboxMode) {
        throw new Error('Polar payment provider is not configured. Set POLAR_ORGANIZATION_ACCESS_TOKEN and POLAR_SANDBOX_MODE environment variables.');
    }
...
export const polarClient = new Proxy({}, {
    get(target, prop) {
        return getPolarClient()[prop];
    }
});
//# sourceMappingURL=polarClient.js.map