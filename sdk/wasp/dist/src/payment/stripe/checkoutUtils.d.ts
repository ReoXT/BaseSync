...
export declare function createStripeCheckoutSession({ priceId, customerId, mode, returnUrl, }: CreateStripeCheckoutSessionParams): Promise<Stripe.Checkout.Session>;
export {};
